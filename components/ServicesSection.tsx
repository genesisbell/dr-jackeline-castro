      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex justify-center sm:hidden">
          <button
            ...
            style={{ borderColor: 'var(--brand-teal)', color: 'var(--brand-teal-dark)' }}
          >
...
const PILL_PALETTES = [
  { bg: 'var(--brand-rose-bg)', border: 'var(--brand-rose)', text: 'var(--brand-rose-dark)' },
  { bg: 'var(--brand-teal-bg)', border: 'var(--brand-teal)', text: 'var(--brand-teal-dark)' },
  { bg: 'var(--brand-mint-bg)', border: 'var(--brand-mint)', text: 'var(--brand-mint-dark)' },
];

function ConditionPill({ label, index }: { label: string; index: number }) {
  const p = PILL_PALETTES[index % 3];
